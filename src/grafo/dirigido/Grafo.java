 ...
 */
public class Grafo<T> implements Iterable<Vertice<T>> {
	 ...
	 * Se o Vertice ja existir (pelo nome), o objeto nao � criado. Caso contrario,
	 * um
	...
	/**
	 * M�todo que localiza e retorna a referencia para um vertice existente no
	 * grafo.
	 * 
	 ...
	 * @return <b>true</b>, caso o vertice perten�a ao grafo, ou <b>false</b> caso
	 *         contrario.
	 */
	 ...
	 * O m�todo se encarreda de adcionar a aresta como ajacente ao vertice de
	 * origem.
	 * 
	 * @param origem  - String que identifica o vertice de origem
	 * @param destino - String que identifica o vertice de destino
	 * @param peso    - O peso da aresta
	 * @return Uma referencia para a aresta criada caso os vertices ja existam. Caso
	 *         contrario,
	 *         retorna null.
	 * 
	 */
	...
	/**
	 * Implementacao do algoritmo BFS (Busca em Profundidade) em um grafo
	 * direcionado,
	 * para obter a menor distancia de um vertice aos demais.
	 * O uso de BFS � apropriado neste caso, pois cada aresta vai ser contada apenas
	 * 1 vez.
	...
	/**
	 * Efetua um percurso em profundidade para evitar rela��es de
	 * multiplas-instancias, na qual
	 * � feita uma poda no grafo para restringi-lo a uma arvore, de forma que cada
	 * vertice s�
	 * tenha um pai. Para isso, o algoritmo DFS() foi modificado para efetuar a
	 * tarefa.
	 * 
	...
	/**
	 * Efetua um percurso em profundidade, baseado no algoritmo
	 * Deep-First-Search(DFS).
	 * Este m�todo faz o percurso utilizando um vertice inicial, at� o vertice n que
	 * esteja
	 * na rede do v�rtice inicial.
	 * OBS: ESTE ALGORITMO � MATRIZ, o qual deve ser usado como c�digo inicial para
	 * adequar
	...
	public Iterator<Vertice<T>> dfsIterator() {
